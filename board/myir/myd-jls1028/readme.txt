myd-jls1028 board is one platform based on LS1028A silicon for industry,
which is supported in LSDK-20.12.

One simple image file is created by buildroot, which includes RCW, ATF,uboot,
